...
const Home = (props) => {
    ...
    return (
        <div className="mx-auto w-8/12 mt-5">
            ...
            <section className=" mx-auto mt-10 p-2 flex justify-center">

                <div className="flex flex-wrap items-center -mx-3 font-sans px-4 mx-auto w-full lg:max-w-screen-lg sm:max-w-screen-sm md:max-w-screen-md pb-20">
