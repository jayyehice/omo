    ...
    return (
        <footer className="bg-black text-white px-4 lg:px-6 py-8">
            <div className="flex justify-between items-center mx-auto max-w-screen-xl">
                <a href="/" className="w-1/6 hidden lg:block"><img src="/static/img/omo_logo_white.png" alt="" /></a>
                <ul className="flex flex-wrap items-center justify-between selection:bg-fuchsia-300 grow lg:mx-36">
                    {contactList}
                </ul>
